            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        fs.writeFile("".concat(this._outputFilename), contentGenerationResult, 'utf8')
                            .then(function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, fs.readFile("./".concat(this._configFilename), { encoding: 'utf-8' })];
                    case 1:
                    ...
                    return [2 /*return*/, vm.runInNewContext(this._configFileData, {
                            __dirname: path.dirname(path.resolve("./".concat(this._configFilename))),
                            require: require,
                            module: {},
                            process: process,
                        })];

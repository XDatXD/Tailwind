...
var colors_1 = tslib_1.__importDefault(require("@colors/colors"));
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        fs_1.promises.writeFile("".concat(this._outputFilename), contentGenerationResult, 'utf8')
                            .then(function () {
                            _this.printCliMessage('success', "Types has successfully been generated in ".concat(_this._outputFilename, " file."));
                        })
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, fs_1.promises.readFile("./".concat(this._configFilename), { encoding: 'utf-8' })];
                    case 1:
                        _a._configFileData = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _b.sent();
                        this.printCliMessage('error', "Error Reading: \"./".concat(this._configFilename, "\""));
                        return [3 /*break*/, 3];
                    case 3: 
                    // Execute the config file content as JavaScript code
                    return [2 /*return*/, vm_1.default.runInNewContext(this._configFileData, {
                            __dirname: path_1.default.dirname(path_1.default.resolve("./".concat(this._configFilename))),
                            require: require,
                            module: {},
                            process: process,
                        })];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!this._outputFilename && !!this._customClassesFilename) {
                            ...
                            customClassesImportPath =
                                customClassesImportPath[0] === '.'
                                    ? customClassesImportPath
                                    : "./".concat(customClassesImportPath);
                        }
                        ...
                        return [2 /*return*/, (fileContentTemplate
                                ...
                                ? "import type TCustomClassesFromExternalFile from '".concat(customClassesImportPath, "';")
                                : '')
        ...
        this.validateCliOptions = function () {
            ...
            if (!!_this._customClassesFilename) {
                return fs_1.promises
                    .readFile("./".concat(_this._customClassesFilename))
                    .then(function (data) {
                    ...
                    .catch(function (error) {
                    _this.printCliMessage('error', "Unable to read the file with custom types. ".concat(error));
                    throw new Error();
                });
            }
